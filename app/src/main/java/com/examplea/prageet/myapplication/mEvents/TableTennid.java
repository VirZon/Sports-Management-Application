...
public class TableTennid extends AppCompatActivity {
    ArrayList<Game> a;
    static HSSFSheet sheet;
    HSSFWorkbook workbook;
    String team_name,captain_name,game_id="Table Tennis";
...
// arraylist to keep the selected items
                ...
                AlertDialog dialog = new AlertDialog.Builder(TableTennid.this)
                        ...
                        .setMultiChoiceItems(items, null, new DialogInterface.OnMultiChoiceClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int indexSelected, boolean isChecked) {
                              ...
                              //      Toast.makeText(TableTennid.this,""+indexSelected,Toast.LENGTH_SHORT).show();
                                    seletedItems.add(indexSelected);
                                } else if (seletedItems.contains(indexSelected)) {
                                    single[0] =0;
                                    doubles[0] = 0;
                              //      Toast.makeText(TableTennid.this,"NICE",Toast.LENGTH_SHORT).show();
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if(doubles[0]==1)
                                {
                                    LayoutInflater factory = LayoutInflater.from(TableTennid.this);
...
//text_entry is an Layout XML file containing two text field to display in alert dialog
                                    ...
                                    final AlertDialog.Builder alert = new AlertDialog.Builder(TableTennid.this);
                                            ...
                                            .setPositiveButton("Submit",
                                                    new DialogInterface.OnClickListener() {
                                                        public void onClick(DialogInterface dialog, int whichButton) {
                                                            ...
                                                            if(team_name.equals(""))
                                                            {
                                                                Toast.makeText(TableTennid.this,"Enter the Value in Team Name",Toast.LENGTH_SHORT).show();
                                                            }
                                                            else{
                                                                set();
                                                            };
                                ...
                                {
                                    Toast.makeText(TableTennid.this, "Please Select a Value", Toast.LENGTH_SHORT).show();
                                }
            ...
            public void onClick(View view) {
                ...
                databasegames.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        File file = new File(TableTennid.this.getExternalFilesDir(null), game_id+".xls");
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    TableTennid.this.startActivity(intent);
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(TableTennid.this, "Could not Load Number to place the call.", Toast.LENGTH_SHORT).show();
                }
            }
        });
