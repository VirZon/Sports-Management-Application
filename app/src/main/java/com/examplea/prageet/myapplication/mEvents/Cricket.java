...
public class Cricket extends AppCompatActivity {
    ...
    String team_name,captain_name,game_id="Cricket";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LayoutInflater factory = LayoutInflater.from(Cricket.this);
...
//text_entry is an Layout XML file containing two text field to display in alert dialog
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(Cricket.this);
                        ...
                        .setPositiveButton("Submit",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        ...
                                        if(team_name.equals(""))
                                        {
                                            Toast.makeText(Cricket.this,"Enter the Value in Team Name",Toast.LENGTH_SHORT).show();
                                        }
                                        else{
                                            set();
                                        }
            ...
            public void onClick(View view) {
                ...
                databasegames.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        File file = new File(Cricket.this.getExternalFilesDir(null), game_id+".xls");
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(Cricket.this, "Could not Load Number to place the call.", Toast.LENGTH_SHORT).show();
                }
            }
        });
