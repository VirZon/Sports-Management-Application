...
public class VolleyBall extends AppCompatActivity {
    ...
    String team_name,captain_name,game_id="Volleyball";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LayoutInflater factory = LayoutInflater.from(VolleyBall.this);
...
//text_entry is an Layout XML file containing two text field to display in alert dialog
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(VolleyBall.this);
                        ...
                        .setPositiveButton("Submit",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        ...
                                        if(team_name.equals(""))
                                        {
                                            Toast.makeText(VolleyBall.this,"Enter the Value in Team Name",Toast.LENGTH_SHORT).show();
                                        }
                                        else{
                                            set();
                                        };
            ...
            public void onClick(View view) {
                ...
                databasegames.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        File file = new File(VolleyBall.this.getExternalFilesDir(null), game_id+".xls");
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(VolleyBall.this, "Could not Load Number to place the call.", Toast.LENGTH_SHORT).show();
                }
            }
        });
