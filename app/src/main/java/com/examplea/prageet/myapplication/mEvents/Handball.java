...
import com.examplea.prageet.myapplication.Fetch;
...
public class Handball extends AppCompatActivity {
    ...
    String team_name,captain_name,game_id="Handball";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LayoutInflater factory = LayoutInflater.from(Handball.this);
...
//text_entry is an Layout XML file containing two text field to display in alert dialog
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(Handball.this);
                        ...
                        .setPositiveButton("Submit",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        ...
                                        if(team_name.equals(""))
                                        {
                                            Toast.makeText(Handball.this,"Enter the Value in Team Name",Toast.LENGTH_SHORT).show();
                                        }
                                        else{
                                            set();
                                        };
            ...
            public void onClick(View view) {
                ...
                databasegames.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        File file = new File(Handball.this.getExternalFilesDir(null), game_id+".xls");
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    Handball.this.startActivity(intent);
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(Handball.this, "Could not Load Number to place the call.", Toast.LENGTH_SHORT).show();
                }
            }
        });
