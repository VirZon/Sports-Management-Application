...
public class GullyCricket extends AppCompatActivity {
    ArrayList<Game> a;
    static HSSFSheet sheet;
    HSSFWorkbook workbook;
    String team_name,captain_name,game_id="Gully Cricket";
    DatabaseReference databasegames;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ArrayList<String> arrayList = new ContactArray().getArrayList();
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gullycricket);
        Button reg = (Button)findViewById(R.id.reg);
        reg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LayoutInflater factory = LayoutInflater.from(GullyCricket.this);
...
//text_entry is an Layout XML file containing two text field to display in alert dialog
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(GullyCricket.this);
                        ...
                        .setPositiveButton("Submit",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        ...
                                        if(team_name.equals(""))
                                        {
                                            Toast.makeText(GullyCricket.this,"Enter the Value in Team Name",Toast.LENGTH_SHORT).show();
                                        }
                                        else{
                                            set();
                                        };
            ...
            public void onClick(View view) {
                ...
                databasegames.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        File file = new File(GullyCricket.this.getExternalFilesDir(null), game_id+".xls");
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    GullyCricket.this.startActivity(intent);
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(GullyCricket.this, "Could not Load Number to place the call.", Toast.LENGTH_SHORT).show();
                }
            }
        });
