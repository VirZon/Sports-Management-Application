...
public class Carrom extends AppCompatActivity {
    ...
    String team_name,captain_name,game_id="Carrom";
...
// arraylist to keep the selected items
                ...
                AlertDialog dialog = new AlertDialog.Builder(Carrom.this)
                      ...
                      //              Toast.makeText(Carrom.this,""+indexSelected,Toast.LENGTH_SHORT).show();
                                    seletedItems.add(indexSelected);
                                } else if (seletedItems.contains(indexSelected)) {
                                    single[0] =0;
                                    doubles[0] = 0;
                        //            Toast.makeText(Carrom.this,"NICE",Toast.LENGTH_SHORT).show();
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if(doubles[0]==1)
                                {
                                    LayoutInflater factory = LayoutInflater.from(Carrom.this);
...
//text_entry is an Layout XML file containing two text field to display in alert dialog
                                    ...
                                    final AlertDialog.Builder alert = new AlertDialog.Builder(Carrom.this);
                                            ...
                                            .setPositiveButton("Submit",
                                                    new DialogInterface.OnClickListener() {
                                                        public void onClick(DialogInterface dialog, int whichButton) {
                                                            ...
                                                            if(team_name.equals(""))
                                                            {
                                                                Toast.makeText(Carrom.this,"Enter the Value in Team Name",Toast.LENGTH_SHORT).show();
                                                            }
                                                            else{
                                                                set();
                                ...
                                {
                                    Toast.makeText(Carrom.this, "Please Select a Value", Toast.LENGTH_SHORT).show();
                                }
                ...
                databasegames.addListenerForSingleValueEvent(new ValueEventListener() {
                 ...
                 //       Collections.sort(a,Game.s);
                      ...
                      //      System.out.println(s.player_name);
                        ...
                        File file = new File(Carrom.this.getExternalFilesDir(null), game_id+".xls");
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    Carrom.this.startActivity(intent);
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(Carrom.this, "Could not Load Number to place the call.", Toast.LENGTH_SHORT).show();
                }
            }
        });
